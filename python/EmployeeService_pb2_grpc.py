...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmployeeSalaryMean = channel.unary_unary(
                '/employee_service.EmployeeService/GetEmployeeSalaryMean',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeSalaryMean.FromString,
                )
        self.RaiseEmployeeSalaryByPercentage = channel.unary_unary(
                '/employee_service.EmployeeService/RaiseEmployeeSalaryByPercentage',
                request_serializer=EmployeeService__pb2.EmployeeSalaryRaise.SerializeToString,
                response_deserializer=EmployeeService__pb2.StatusReply.FromString,
                )
...
class EmployeeServiceServicer(object):
    ...
    def RaiseEmployeeSalaryByPercentage(self, request, context):
        """Update the salary of the employees raising by a percentage
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetEmployeeSalaryMean': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeeSalaryMean,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeSalaryMean.SerializeToString,
            ),
            'RaiseEmployeeSalaryByPercentage': grpc.unary_unary_rpc_method_handler(
                    servicer.RaiseEmployeeSalaryByPercentage,
                    request_deserializer=EmployeeService__pb2.EmployeeSalaryRaise.FromString,
                    response_serializer=EmployeeService__pb2.StatusReply.SerializeToString,
            ),
    }
...
class EmployeeService(object):
    ...
    @staticmethod
    def GetEmployeeSalaryMean(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/GetEmployeeSalaryMean',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.EmployeeSalaryMean.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def RaiseEmployeeSalaryByPercentage(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/RaiseEmployeeSalaryByPercentage',
            EmployeeService__pb2.EmployeeSalaryRaise.SerializeToString,
            EmployeeService__pb2.StatusReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
